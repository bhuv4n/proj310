...
<br><br>
            ...
            <!-- Profile info --> <?php if (!empty($user_data)): ?> <p>Your Information<p>
            <table>
                <tr>
                    <th>Username</th>
...
<a href="customer_choice.php" class="button"><strong>BACK TO MENU</strong></a> <?php else: ?> <p>User not found.</p> <?php endif; ?>
